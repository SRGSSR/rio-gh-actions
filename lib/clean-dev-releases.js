...
try {
    function run() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const versionsToDelete = allVersions.reduce((acc, version) => {
                var _a;
                if (new Date(version.created_at).getTime() < untilTimestamp && ((_a = version.name.match(utils_1.DEV_VERSION_NAME_REGEX)) === null || _a === void 0 ? void 0 : _a.length)) {
                    return [...acc, version];
                }
                return acc;
            }, []);
